        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-header">
                    <h4>CREATE <span class="wscl">UPWORK PROFILE</span></h4>
                </div>
                <div class="card-body wssi">
                    <h4 class="card-title"></h4>
                    <form method="POST" action="{{ url('admin/add-upwork') }}" class="forms-sample">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="profile_link" rows="4" name="up_link" autocomplete="false"></textarea>
                            @error('up_link')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
